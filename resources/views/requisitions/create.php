...
class RequisitionsController extends Controller
{
    ...
    public function store(StoreRequisitionRequest $request)
    {
        ...
        //    $requisition->coordinations()->attach([$requisition->departments()->attach($request->department_id)]);

        //$requisition->coordination_id = $request->input('coordination_id');
        //$requisition->department_id = $request->input('department_id');
        ...
        //$requisition->departure = $request->input('departure');
        ...
        // return redirect('activities')->with('success', 'Actividades agregadas correctamente');
    }
...
//         $collect->dd();
        ...
        //return  $matrix->all();
        return view('requisitions.show', compact('requisitions','department','nametitular','roltitular','coordination'));
    }
